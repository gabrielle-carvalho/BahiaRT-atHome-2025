...
class PeopleRecognition(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(String, '/status_nav', self.turned_callback, 10)
        ...
        self.recognition_count = 0  # Contador de reconhecimentos
        ...
        for face in faces:
            ...
            if name != "Unknown":
                ...
                if self.detection_count[name] == 12:
                    ...
                    self.publish_recognition_completed(name)  # Publique a conclusão
...
class App:
    ...
    def open_camera(self):
        max_attempts = 5000000  # Número máximo de tentativas
        attempts = 0
